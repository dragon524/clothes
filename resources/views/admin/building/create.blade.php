            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="location_latitude" class="form-control" value="{{old('location_latitude')}}"/>
                                <label class="form-label">Latitude</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="location_longitude" class="form-control" value="{{old('location_longitude')}}"/>
